...
<div class="container">
    <input type="hidden" name="product" id="rod_id" value='{$product->id_product}'>
    <form class="formulario" id="commentForm" method="POST" action="comentarios">
        ...
        <input type="text" name="product_id" id='prod_id' value='{$product->id_product}' data='{$product->id_product}' readonly>
        ...
        <label class="comment" for="comentario"><h2>Comentario</h2></label>
        <textarea name="comentario" class="comment" id="comment" cols="60" rows="10"></textarea>
        <!--<input class="comment" type="submit" id="btn-send">-->
        <input type="submit" class="btn btn-info mt-2" value="Enviar" id="btn">
